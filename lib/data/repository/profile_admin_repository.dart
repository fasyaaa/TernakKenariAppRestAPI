...
import 'package:carnary/data/model/request/admin/admin_profile_request.dart';
import 'package:carnary/data/model/response/admin_profile_response_model.dart';
  ...
  Future<Either<String, AdminProfileResponseModel>> addProfile(
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        log("Add Admin Profile Succcesful: ${profileResponse.message}");
      ...
      return Left("An error occued while adding profile: $e");
    }
  }
